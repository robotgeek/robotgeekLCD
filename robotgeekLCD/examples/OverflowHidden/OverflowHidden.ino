...
void setup() 
{
  ...
  lcd.init(20,4,false); //This is a hack to stop all overflow. lcd.init(16,2,false); will only hide up to 40 characters, in order to preserve the scroll and autoscroll functions. By calling the init() for the 20x4 screen we can trick the system into hiding all overflow
  // Print a message to the LCD.
  lcd.print("Overflow is hidden, anything past the 16th character is not displayed.");
  //
}
