...
boolean field[4][20];   //4x20 array to keep track of where hearts are being displayed on the screen. 0 means no heart and 1 means a heart exists
...
void generateHeartField()
{
  ...
  for(int i=0;i<4;i++)
  {
     ...
     for(int j = 0;j<20;j++)
    {
       ...
       {
        lcd.print("a");       //write a blank ' '(space) to the lcd
...
void resetHero()
{
  ...
  field[heroRowPosition][heroColumnPosition] = 0;
}
