...
{ 
  ...
  lcd.init(4,20);      // initlaize the lcd object - this sets up all the variables and IIC setup for the LCD object to work
...
void loop() 
{
  ...
  lcd.print("Button:");     //print the label for the button value
  ...
  lcd.print("Knob:");     //print the label for the Knob value
  ...
  lcd.setCursor(0, 2);  //manually set the LCD to (8,0) - 9th character in the first row(Lower left quadrant)
  lcd.print("X Joystick:");      //print the label for the horizontal joystick value
  lcd.print(joystickHorizontalValue);//print the actual joystick value
  lcd.print("   ");     //print '   '(three spaces). This will clear away old text when the knobValue number goes from a high number to a low number (i.e. from a 4 digit number down to a 1 digit number)
 
  lcd.setCursor(0, 3);  //manually set the LCD to (8,1) - 9th character in the second row(Lower right quadrant)
  lcd.print("Y Joystick:");      //print the label for the vertical joystick value
